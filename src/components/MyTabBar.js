...
const icons = {
  focus: {
    Home: iconHomeActive,
    TabHistory: iconHistoryActive,
    TabPost: iconPostActive,
    TabAccount: iconAccountActive,
  },
  nonfocus: {
    Home: iconHome,
    TabHistory: iconHistory,
    TabPost: iconPost,
    TabAccount: iconAccount,
  },
};
...
export default function MyTabBar({state, descriptors, navigation}) {
  ...
  const bgColor = React.useMemo(
    () => descriptors[state.routes[state.index].key].options.bgColor,
    [state],
  );
  return (
