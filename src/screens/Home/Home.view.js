        ...
        <HomeContainer>
          <HStackBetween>
            <HStackStart>
              ...
              <Gap $width={15} />
              {isLoggedIn ? (
                <Text18Bold $color={colors.dark}>
                  Xin chào, {infoUser.lastname}
                </Text18Bold>
              ) : (
                <TouchableOpacity onPress={() => goPageLogin()}>
                  <Text18Bold $color={colors.dark}>Đăng nhập</Text18Bold>
                </TouchableOpacity>
              )}
            </HStackStart>
            <HStackStart>
          ...
          <HomePoint>
            ...
            <View>
              <HStackEnd>
                ...
                <Text14Medium $color={colors.dark}>
          ...
          <AutoScroll endPadding={50}>
            <Text15Medium>Hôm nay là một ngày tuyệt vời!</Text15Medium>
          </AutoScroll>
          <Gap $height={30} />
          <HStackBetween>
            <TouchableOpacity
            ...
            <TouchableOpacity
              onPress={() => navigate('Tab', {screen: 'TabPost'})}>
